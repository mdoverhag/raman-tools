#!/usr/bin/env python3
"""
Experiment: MCF7 Passive Ag-coated with FcR Block
Date: 2025-09-01
Description: MCF7 passive conjugation, silver coated, with FcR Block at 37°C for 30 min.
"""
...
SAMPLE_DIR = os.path.expanduser(
    "~/Documents/Spectroscopy Results/2025-09-01 Passive Ag coated FcR block 37deg 30min"
)
...
output = create_output_dir("2025-09-01-passive-ag-coated-fcr-block", base_dir="results")
